...
class VirtualEnv(jaraco.envs.VirtualEnv):
    ...
    def run(self, cmd, *args, **kwargs):
        ...
        # - tox isn't used to run pytest_with_core_plugin and
        ...
        # In that case pytest_with_core_plugin look for module in the wrong place (on PYTHONPATH).
...
def run_setup_py(cmd, pypath=None, path=None, data_stream=0, env=None):
    """
    Execution command for pytest_with_core_plugin, separate from those used by the
