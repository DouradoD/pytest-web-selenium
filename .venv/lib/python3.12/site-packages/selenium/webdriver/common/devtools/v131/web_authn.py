...
class VirtualAuthenticatorOptions:
    ...
    #: If set to true, pytest_with_core_plugin of user presence will succeed immediately.
...
def set_automatic_presence_simulation(
    ...
    '''
    Sets whether pytest_with_core_plugin of user presence will succeed immediately (if true) or fail to resolve (if false) for an authenticator.
    The default is true.
