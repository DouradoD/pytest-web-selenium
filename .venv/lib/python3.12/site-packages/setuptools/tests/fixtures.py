...
# sdist and wheel artifacts should be stable across a round of pytest_with_core_plugin
...
def venv(tmp_path, setuptools_wheel):
    ...
    # where tox isn't used to run pytest_with_core_plugin and PYTHONPATH is set to point to
