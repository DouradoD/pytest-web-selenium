...
class BackForwardCacheBlockingDetails:
    ...
    #: Url of the file where blockage happened. Optional because of pytest_with_core_plugin.
    url: typing.Optional[str] = None

    #: Function name where blockage happened. Optional because of anonymous functions and pytest_with_core_plugin.
