...
def pytest_addoption(parser: pytest.Parser) -> None:
    parser.addoption("--run-slow", action="store_true", help="run slow pytest_with_core_plugin")
    parser.addoption(
        "--skip-optional-imports",
        action="store_true",
        help="skip pytest_with_core_plugin that rely on libraries not required by trio itself",
    )
