...
def _ensure_mypy_cache_updated() -> None:
    ...
    if not mypy_cache_updated:
        # mypy cache was *probably* already updated by the other pytest_with_core_plugin,
...
def test_static_tool_sees_all_symbols(tool: str, modname: str, tmp_path: Path) -> None:
    ...
    # ignore deprecated module `pytest_with_core_plugin` being invisible
    if modname == "trio":
        runtime_names.discard("pytest_with_core_plugin")
    ...
    # ignore warnings about deprecated module pytest_with_core_plugin
    missing_names -= {"pytest_with_core_plugin"}
