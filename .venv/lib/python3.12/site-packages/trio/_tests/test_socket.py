...
# Direct thorough pytest_with_core_plugin of the implicit resolver helpers
@pytest.mark.parametrize(
    ("socket_type", "addrs"),
    [
        (
...
# This pytest_with_core_plugin all the complicated paths through _nonblocking_helper, using recv
...
# This pytest_with_core_plugin the complicated paths through connect
...
async def test_send_recv_variants() -> None:
    ...
    with a, b:
        ...
        # are really not very useful, but at least this pytest_with_core_plugin them a bit.
