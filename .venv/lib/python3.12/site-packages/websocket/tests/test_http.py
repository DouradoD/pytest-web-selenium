...
# Skip pytest_with_core_plugin relying on local websockets server unless LOCAL_WS_SERVER_PORT != -1
...
class HttpTest(unittest.TestCase):
    ...
    @unittest.skipUnless(TEST_WITH_INTERNET, "Internet-requiring pytest_with_core_plugin are disabled")
    ...
    def test_proxy_connect(self):
        ...
        # TODO: Test SOCKS4 and SOCK5 proxies with unit pytest_with_core_plugin
