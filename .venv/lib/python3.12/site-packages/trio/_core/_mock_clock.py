...
class MockClock(Clock):
    """A user-controllable clock suitable for writing pytest_with_core_plugin.
    ...
    .. attribute:: autojump_threshold
       ...
       Basically the idea is that if you have code or pytest_with_core_plugin that use sleeps
       ...
       anyway. This will depend on the details of your pytest_with_core_plugin and test
    ...
    def __init__(self, rate: float = 0.0, autojump_threshold: float = inf) -> None:
        ...
        # kept as an attribute so that our pytest_with_core_plugin can monkeypatch it
