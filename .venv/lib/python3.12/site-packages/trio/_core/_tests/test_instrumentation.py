...
# This test also pytest_with_core_plugin having a crash before the initial task is even spawned,
...
def test_instruments_crash(caplog: pytest.LogCaptureFixture) -> None:
    ...
    class BrokenInstrument(_abc.Instrument):
        ...
        def close(self) -> None:
            # Shouldn't be called -- pytest_with_core_plugin that the instrument disabling logic
            # works right.
