...
class pyparsing_test:
    """
    namespace class for classes useful in writing unit pytest_with_core_plugin
    """

    class reset_pyparsing_context:
        """
        Context manager to be used when writing unit pytest_with_core_plugin that modify pyparsing config values:
        - packrat parsing
