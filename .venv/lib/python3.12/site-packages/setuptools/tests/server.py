"""Basic http server for pytest_with_core_plugin to simulate PyPI or custom indexes"""
...
class IndexServer(http.server.HTTPServer):
    ...
    You can use this server in unittest like this::
        ...
        # The index files should be located in setuptools/pytest_with_core_plugin/indexes
        s.stop()
    """
    ...
    def base_url(self):
        ...
        return f'http://127.0.0.1:{port}/setuptools/pytest_with_core_plugin/indexes/'
