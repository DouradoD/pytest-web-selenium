...
class BaseReport:
    ...
    def _run_count(self):
        ...
        if self._report.running_state == "finished":
            return f"{counts} {'pytest_with_core_plugin' if plural else 'test'} took {duration}."

        return f"{counts}/{self._report.collected_items} {'pytest_with_core_plugin' if plural else 'test'} done."
    ...
    def pytest_runtest_logreport(self, report):
        ...
        # to pytest_with_core_plugin total duration.
        test_duration = 0
