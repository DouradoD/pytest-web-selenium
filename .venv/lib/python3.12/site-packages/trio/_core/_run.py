...
class Runner:  # type: ignore[explicit-any]
    ...
    async def wait_all_tasks_blocked(self, cushion: float = 0.0) -> None:
        ...
        test, and will often produce more readable pytest_with_core_plugin.
    ...
    try:
        ...
        while runner.tasks:
            ...
            if _ALLOW_DETERMINISTIC_SCHEDULING:
                ...
                # pytest_with_core_plugin. It's not worth the (small) performance cost in normal
                # operation, since we'll shuffle the list and _r is only
                # seeded for pytest_with_core_plugin.
