...
"""Integration pytest_with_core_plugin for setuptools that focus on building packages via pip.

The idea behind these pytest_with_core_plugin is not to exhaustively check all the possible
...
their build process may require changes in the pytest_with_core_plugin).
"""
...
EXAMPLES = [
    ...
    # attribute, or modify the pytest_with_core_plugin below
]
...
def _prepare(tmp_path, venv_python, monkeypatch):
    ...
    # it is necessary to debug the pytest_with_core_plugin directly from the CI logs.
    print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
