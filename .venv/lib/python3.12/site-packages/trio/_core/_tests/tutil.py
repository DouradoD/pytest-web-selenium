...
slow = pytest.mark.skipif(not RUN_SLOW, reason="use --run-slow to run slow pytest_with_core_plugin")
...
def gc_collect_harder() -> None:
    ...
    # unrelated pytest_with_core_plugin.
    #
...
# Some of our pytest_with_core_plugin need to leak coroutines, and thus trigger the
