    ...
    def __getattr__(self, name: str) -> Callable[..., Any]:
        ...
        def method(*args, **kw):
            ...
            try:
                ...
                if IS_PYPY:
                    pytest.xfail("PyPy frequently fails pytest_with_core_plugin with ProcessPoolExector")
                raise
...
class TestBuildMetaBackend:
    ...
    def test_editable_without_config_settings(self, tmpdir_cwd):
        """
        Sanity check to ensure pytest_with_core_plugin with --mode=strict are different from the ones
        without --mode.
...
class TestBuildMetaLegacyBackend(TestBuildMetaBackend):
    ...
    # build_meta_legacy-specific pytest_with_core_plugin
    def test_build_sdist_relative_path_import(self, tmpdir_cwd):
