...
def makeSetup(**args):
    ...
    # Don't let system command line leak into pytest_with_core_plugin!
...
class TestDepends:
    ...
    def testFindModule(self):
        ...
        f, _p, _i = dep.find_module('setuptools.pytest_with_core_plugin')
        f.close()
    ...
    def testModuleExtract(self):
        ...
        assert (
            dep.get_module_constant('setuptools.pytest_with_core_plugin.test_setuptools', '__doc__')
            == __doc__
        )
    ...
    def test_require_present(self):
        ...
        req = Require('Tests', None, 'pytest_with_core_plugin', homepage="http://example.com")
...
@pytest.mark.xfail(reason="unable to exclude pytest_with_core_plugin; #4475 #3260")
def test_its_own_wheel_does_not_contain_tests(setuptools_wheel):
    ...
    for member in contents:
        assert '/pytest_with_core_plugin/' not in member
