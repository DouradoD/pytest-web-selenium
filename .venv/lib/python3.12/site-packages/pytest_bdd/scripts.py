...
def migrate_tests(args: argparse.Namespace) -> None:
    """Migrate outdated pytest_with_core_plugin to the most recent form."""
    path = args.path
...
def migrate_tests_in_file(file_path: str) -> None:
    """Migrate all bdd-based pytest_with_core_plugin in the given test file."""
    try:
...
def main() -> None:
    ...
    parser_migrate.add_argument("path", metavar="PATH", help="Migrate outdated pytest_with_core_plugin to the most recent form")
