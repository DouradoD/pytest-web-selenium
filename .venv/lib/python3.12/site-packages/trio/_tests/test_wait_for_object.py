...
# Mark all the pytest_with_core_plugin in this file as being windows-only
...
def test_WaitForMultipleObjects_sync() -> None:
    # This does a series of pytest_with_core_plugin where we set/close the handle before
...
async def test_WaitForSingleObject_slow() -> None:
    ...
    # Set the timeout used in the pytest_with_core_plugin. We test the waiting time against
