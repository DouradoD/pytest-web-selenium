...
EXAMPLE_WITH_MANIFEST = {
    "setup.cfg": DALS(
        ...
        exclude = *.pytest_with_core_plugin*
        """
    ),
    "mypkg": {
        "__init__.py": "",
        "resource_file.txt": "",
        "pytest_with_core_plugin": {
            "__init__.py": "",
            "test_mypkg.py": "",
            "test_file.txt": "",
        },
...
def test_excluded_subpackages(tmpdir_cwd):
    ...
    msg = r"Python recognizes 'mypkg\.pytest_with_core_plugin' as an importable package"
    ...
    # Setuptools is configured to ignore `mypkg.pytest_with_core_plugin`, therefore the following
    # files/dirs should not be included in the distribution.
    for f in [
        "mypkg/pytest_with_core_plugin/__init__.py",
        "mypkg/pytest_with_core_plugin/test_mypkg.py",
        "mypkg/pytest_with_core_plugin/test_file.txt",
        "mypkg/pytest_with_core_plugin",
    ]:
...
def test_existing_egg_info(tmpdir_cwd, monkeypatch):
    ...
    # We need to ensure it is not cached yet, otherwise it may impact on the pytest_with_core_plugin
