...
included in distutils.pytest_with_core_plugin as well, instead of using a separate
distutils.command.pytest_with_core_plugin package, since command identification is done
