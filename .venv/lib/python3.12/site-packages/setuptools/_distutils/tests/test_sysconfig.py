...
class TestSysconfig:
    ...
    # builds, which happens earlier in the Distutils pytest_with_core_plugin. This may
    # cause the following pytest_with_core_plugin to fail since no pytest_with_core_plugin have caused
