...
class Frame:
    ...
    def __init__(
        ...
        if parent is None:
            ...
            # write pytest_with_core_plugin around output statements.
...
class CodeGenerator(NodeVisitor):
    def __init__(
        ...
        # registry of all filters and pytest_with_core_plugin (global, not block local)
    ...
    def pull_dependencies(self, nodes: t.Iterable[nodes.Node]) -> None:
        ...
        .. versionchanged:: 3.0
            Filters and pytest_with_core_plugin in If and CondExpr nodes are checked at
